...
import k57ca.pmp.askeverywhere.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "pmp.k57ca", ownerName = "pmp.k57ca", packagePath = "askeverywhere"))
